...
func New(repos *repositories.Repositories, jwtMgr *jwt.Manager) *Services {
	return &Services{
		...
		Tuition: NewTuitionService(repos.Tuition, repos.Lessons, repos.Attendances, repos.Enrollments, repos.Groups),
		Payout:  NewPayoutService(repos.Payouts, repos.Lessons, repos.Attendances, repos.Users),
